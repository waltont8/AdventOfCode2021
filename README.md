...
<br>**Edit** : I uploaded the Haskell parser. I abandoned it without much testing once I got the answers for free by reading the text file, so it's not much use, but may as well live here.

## Day 25: Sea Cucumber
Easy puzzle for xMas day and a fun one. I like the visual, grid based ones. Made it to 50 stars, done on the right day. Completed the challenge I set myself. It's all good! It would be fun to get on the leaderboard one day if the timezones align better.
